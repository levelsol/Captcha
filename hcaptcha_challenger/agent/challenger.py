...
class AgentConfig(BaseSettings):
    ...
    def validate_ollama_url(cls, v: Any) -> str:
        """
        Validates that the OLLAMA_URL is not empty.
        ...
        if not v or not isinstance(v, str):
            raise ValueError(
                "OLLAMA_URL is required but not provided. "
                "Please either pass it directly or set the OLLAMA_URL environment variable."
                "Default: http://localhost:11434"
            )
        return v
